...
public class Hilo2 extends Thread{
	...
	public void run(){
		while(activo==true){
			...
			if(i==1){
				Panel.dos.setIcon(new ImageIcon(Panel.img1));
				c=1;
			}
			if(i==2){
				Panel.dos.setIcon(new ImageIcon(Panel.img2));
				c=2;
			}
			if(i==3){
				Panel.dos.setIcon(new ImageIcon(Panel.img3));
				c=3;
			}
            if(i==4){
				Panel.dos.setIcon(new ImageIcon(Panel.img4));
				c=4;
			}
			try{
				sleep(tiempo);
